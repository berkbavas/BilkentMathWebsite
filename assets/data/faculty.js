export const CURRENT_FACULTY = [
    {
        ...
        research: {
            en: ["Classical and Exploratory Statistics", "Forecasting", "Statistical Decision Making"],
            tr: ["Klasik istatistik", "kestirim", "istatistiksel karar verme kuramı"]
        },
        office: "SA-144",
...

    {
        ...
        research: {
            en: ["Finite groups", "representation theory", "local and Clifford theory", "G-algebras", "G-posets"],
            tr: ["Sonlu gruplar", "gösterim kuramı", "Clifford kuramı", "G-cebirleri"]
        },
        office: "SA-129",
...

    {
        ...
        research: {
            en: ["Functional analysis", "operator theory", "mathematical physics", "numerical analysis"],
...

    {
        ...
        research: {
            en: ["Analytic number theory"],
            tr: ["Analitik sayılar kuramı"]
        },
        office: "SA-131",
...

    {
        ...
        research: {
            en: ["Theoretical physics", "gravitation and cosmology"],
            tr: ["Kuramsal fizik", "yerçekimi ve kozmoloji"]
        },
        office: "SA-137",
...

    {
        ...
        research: {
            en: ["Arithmetic geometry", "algebraic geometry", "tropical geometry"],
            tr: ["Aritmetik geometri", "cebirsel geometri", "tropikal geometri"]
        },
        office: "SA-105",
...

    {
        ...
        research: {
            en: ["Mathematical theory of statistical physics", "probability", "mathematical analysis"],
            tr: ["İstatistiksel fiziğin matematiksel kuramı", "olasılık", "matematiksel analiz"]
        },
        office: "SA-120",
...

    {
        ...
        research: {
            en: ["Complex analysis", "potential theory", "functional analysis"],
            tr: ["Karmaşık analiz", "potansiyel kuramı", "fonksiyonel analiz"]
        },
        office: "SA-109",
...

    {
        ...
        research: {
            en: ["Algebraic topology", "quantum information theory"],
            tr: ["Cebirsel topoloji", "quantum enformasyon kuramı"]
        },
        office: "SA-140",
...

    {
        ...
        research: {
            en: ["Stochastic control theory", "game theory", "machine learning", "information theory", "probability theory and its applications"],
            tr: ["Stokastik denetim kuramı", "oyun kuramı", "makine öğrenmesi", "enformasyon kuramı", "olasılık kuramı ve uygulamaları"]
        },
        office: "SA-139",
...

    {
        ...
        research: {
            en: ["Commutative algebra", "invariant theory"],
            tr: ["Değişmeli cebir", "değişmezlik teorisi"]
        },
        office: "SA-117",
...

    {
        ...
        research: {
            en: ["Differential geometry", "global analysis on manifolds", "general relativity and quantum field theories"],
            tr: ["Diferansiyel geometri", "Riemann geometrisi", "katmanlı uzaylarda global analiz"]
        },
        office: "SA-118",
...

    {
        ...
        research: {
            en: ["Algebraic topology", "geometric group theory"],
            tr: ["Cebirsel geometri", "geometrik grup kuramı"]
        },
        office: "SA-123",
...

    {
        ...
        research: {
            en: ["Cohomology of groups", "finite group actions on topological spaces"],
            tr: ["Grup kohomolojisi", "topolojik uzaylara sonlu grup etkisi", "gruplarla ilişkili geometrik yapılar"]
        },
        office: "SA-127",
...

    {
        ...
        research: {
            en: ["Enumerative combinatorics", "probability", "statistical physics", "data science"],
            tr: ["Saymalı kombinatorik", "olasılık kuramı", "istatistiksel fizik", "veri bilimi"]
        },
        office: "SA-142",
...

    {
        ...
        research: {
            en: ["Representation theory", "finite groups", "block theory", "biset functors"],
            tr: ["Temsil kuramı", "sonlu gruplar", "blok kuramı", "iküme izleçleri"]
        },
        office: "SA-114",
...

    {
        ...
        research: {
            en: ["Theory of entire functions", "Polya frequency sequences"],
            tr: ["Tüm düzlemde analitik fonksiyonlar kuramı", "Polya sıklık dizileri"]
        },
        office: "SA-111b",
