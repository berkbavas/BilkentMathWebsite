  ...
  <main id="content">
    ...
    <section class="home-hero">
      <div class="container">
        <div class="hero-grid">
          <div class="hero-copy">
            <p class="hero-eyebrow">Bilkent University • Department of Mathematics</p>
          ...
          <div class="hero-media">
            <figure class="hero-card">
              <!-- Eski sayfadaki bina fotoğrafının modern kullanımı -->
              <img
      ...
      <div class="container">
        <div class="two-col">
          ...
          <div class="panel">
            ...
            <div class="list">
              <!-- Statik örnek. İstersen JSON/DB’den beslersin -->
